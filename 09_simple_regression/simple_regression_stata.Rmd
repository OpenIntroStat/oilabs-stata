...
Let's consider this output piece by piece. The box in the top left shows the analysis of variance table with the sum of squares.  The "Coefficients" table shown at the bottom is key; its first 
column displays the linear model's y-intercept (`_cons`) and the coefficient of `at_bats`.
...
One last piece of information we will discuss from the summary output is the 
 R-squared, or more simply, $hR^2$. The $R^2$ value represents the 
